...
class LTRTrainer(BaseTrainer):
    ...
    def cycle_dataset(self, loader):
        ...
        for i, data in enumerate(loader, 1):
            ...
            # img_path = data['search_paths'][0][0]

            # file_path = 'sequence_name.txt'

            # with open(file_path, 'w') as file:
            #     file.write(img_path)

            #####################################
            dataset_name_path = 'dataset_name.txt'

            with open(dataset_name_path, 'w') as file:
                for item in data['dataset']:
                    file.write(f"{item}\n")

            sequence_name_path = 'sequence_name.txt'

            with open(sequence_name_path, 'w') as file:
                for item in data['search_paths'][0]:
                    file.write(f"{item}\n")
            #####################################
