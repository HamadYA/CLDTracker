...
from lib.train.dataset import Lasot_lmdb, Got10k_lmdb, MSCOCOSeq_lmdb, ImagenetVID_lmdb, TrackingNet_lmdb, NEW, TNL2K, OTB
...
def names2datasets(name_list: list, settings, image_loader):
    ...
    for name in name_list:
        ...
        assert name in ["LASOT", "GOT10K_vottrain", "GOT10K_votval", "GOT10K_train_full", "GOT10K_official_val",
                        "COCO17", "VID", "TRACKINGNET" , 'NEW', 'TNL2K', 'OTB']
        ...
        if name == "OTB":
            datasets.append(OTB(settings.env.otb_dir, split='train', image_loader=image_loader))
...
def get_optimizer_scheduler(net, cfg):
    ...
    for n, p in net.named_parameters():
        if "category_embedding.clip_model" in n or "category_embedding.logit_scale" in n:
