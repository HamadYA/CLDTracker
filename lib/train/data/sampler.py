    ...
    def getitem(self):
        ...
        while not valid:
            ...
            try:
                ...
                template_frames, template_anno, meta_obj_train, template_paths = dataset.get_frames(seq_id, template_frame_ids, seq_info_dict)
                search_frames, search_anno, meta_obj_test, search_paths = dataset.get_frames(seq_id, search_frame_ids, seq_info_dict)
                ...
                # negative samples
                    ...
                    if is_video_dataset:
                        ...
                        if search_frame_ids is None:
                            ...
                            #                                                                seq_info_dict)
                            search_frames, search_anno, meta_obj_test, search_paths = dataset.get_frames(seq_id, search_frame_ids,
                                                                                                        seq_info_dict)
                            search_anno["bbox"] = [self.get_center_box(H, W)]
                    else:
                        # search_frames, search_anno, meta_obj_test = self.get_one_search()
                        search_frames, search_anno, meta_obj_test, search_paths = self.get_one_search()
