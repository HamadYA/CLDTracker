...
class LaSOTDataset(BaseDataset):
    ...
    def __init__(self):
        ...
        self.text_bag = '/home/mohamadalansari/Documents/CiteTracker_Tracking/WaffleCLIP/tracking_descriptors/final_bag/lasot.json'
    ...
    def _construct_sequence(self, sequence_name):
        ...
        text_bag_json_file = self.load_json(self.text_bag)
        text_bag = {sequence_name: text_bag_json_file[sequence_name]}
